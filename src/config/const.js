...
// Square
export const SQUARE_ENVIROMENT = process.env.REACT_APP_SQUARE_ENVIROMENT;
export const SQUARE_LOCATION_ID = process.env.REACT_APP_SQUARE_LOCATION_ID;
export const SQUARE_SANDBOX_APP_ID = process.env.REACT_APP_SQUARE_SANDBOX_APPLICATION_ID;
export const SQUARE_SANDBOX_ACCESS_TOKEN = process.env.REACT_APP_SQUARE_SANDBOX_ACCESS_TOKEN;
export const SQUARE_PRODUCTION_APP_ID = process.env.REACT_APP_SQUARE_PRODUCTION_APPLICATION_ID;
export const SQUARE_PRODUCTION_ACCESS_TOKEN = process.env.REACT_APP_SQUARE_PRODUCTION_ACCESS_TOKEN;